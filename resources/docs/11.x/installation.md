...
- [Встановлення Docker за допомогою Using Sail](#docker-installation-using-sail)
    - [Sail на macOS](#sail-on-macos)
    - [Sail на Windows](#sail-on-windows)
    - [Sail на Linux](#sail-on-linux)
